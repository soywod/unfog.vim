...
syntax match unfog_wtime_worktime   /\(|.*|\)\@<=.*|/ contains=unfog_wtime_separator
syntax match unfog_wtime_date       /|.\{-}|/         contains=unfog_wtime_separator
syntax match unfog_wtime_total      /|.\{-}|\%$/      contains=unfog_wtime_separator,unfog_wtime_worktime
...
highlight default link unfog_wtime_worktime   String
