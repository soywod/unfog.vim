...
syntax match unfog_table_worktime /^|.\{-}|.\{-}|.\{-}|.\{-}|.\{-}|/  contains=unfog_table_id,unfog_table_desc,unfog_table_tags,unfog_table_active,unfog_separator
...
highlight default link unfog_table_worktime   Structure
